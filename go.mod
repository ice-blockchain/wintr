...
require (
	...
	github.com/containerd/containerd/v2 v2.2.1-0.20251202075220-6cbc28507050 // indirect
	...
	tags.cncf.io/container-device-interface v1.0.2-0.20251126141844-16a1328247ae // indirect
)
