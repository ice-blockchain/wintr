...
func (l *lb) FT_List(ctx context.Context) *redis.StringSliceCmd {
	return l.instance().FT_List(ctx)
}

func (l *lb) FTAggregate(ctx context.Context, index string, query string) *redis.MapStringInterfaceCmd {
	return l.instance().FTAggregate(ctx, index, query)
}

func (l *lb) FTAggregateWithArgs(ctx context.Context, index string, query string, options *redis.FTAggregateOptions) *redis.AggregateCmd {
	return l.instance().FTAggregateWithArgs(ctx, index, query, options)
}

func (l *lb) FTAliasAdd(ctx context.Context, index string, alias string) *redis.StatusCmd {
...
func (l *lb) FTAliasUpdate(ctx context.Context, index string, alias string) *redis.StatusCmd {
	return l.instance().FTAliasUpdate(ctx, index, alias)
}

func (l *lb) FTAlter(ctx context.Context, index string, skipInitialScan bool, definition []interface{}) *redis.StatusCmd {
...
func (l *lb) FTConfigSet(ctx context.Context, option string, value interface{}) *redis.StatusCmd {
...
func (l *lb) FTCursorRead(ctx context.Context, index string, cursorId int, count int) *redis.MapStringInterfaceCmd {
	return l.instance().FTCursorRead(ctx, index, cursorId, count)
}

func (l *lb) FTDictAdd(ctx context.Context, dict string, term ...interface{}) *redis.IntCmd {
	return l.instance().FTDictAdd(ctx, dict, term...)
}

func (l *lb) FTDictDel(ctx context.Context, dict string, term ...interface{}) *redis.IntCmd {
...
func (l *lb) FTExplain(ctx context.Context, index string, query string) *redis.StringCmd {
	return l.instance().FTExplain(ctx, index, query)
}

func (l *lb) FTExplainWithArgs(ctx context.Context, index string, query string, options *redis.FTExplainOptions) *redis.StringCmd {
...
func (l *lb) FTSpellCheck(ctx context.Context, index string, query string) *redis.FTSpellCheckCmd {
	return l.instance().FTSpellCheck(ctx, index, query)
}

func (l *lb) FTSpellCheckWithArgs(ctx context.Context, index string, query string, options *redis.FTSpellCheckOptions) *redis.FTSpellCheckCmd {
	return l.instance().FTSpellCheckWithArgs(ctx, index, query, options)
}

func (l *lb) FTSearch(ctx context.Context, index string, query string) *redis.FTSearchCmd {
	return l.instance().FTSearch(ctx, index, query)
}

func (l *lb) FTSearchWithArgs(ctx context.Context, index string, query string, options *redis.FTSearchOptions) *redis.FTSearchCmd {
...
func (l *lb) FTSynUpdate(ctx context.Context, index string, synGroupId interface{}, terms []interface{}) *redis.StatusCmd {
	return l.instance().FTSynUpdate(ctx, index, synGroupId, terms)
}

func (l *lb) FTSynUpdateWithArgs(ctx context.Context, index string, synGroupId interface{}, options *redis.FTSynUpdateOptions, terms []interface{}) *redis.StatusCmd {
	return l.instance().FTSynUpdateWithArgs(ctx, index, synGroupId, options, terms)
}

func (l *lb) FTTagVals(ctx context.Context, index string, field string) *redis.StringSliceCmd {
