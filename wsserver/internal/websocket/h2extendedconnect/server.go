...
func (c *conn) serve(ctx context.Context) {
	...
	for {
		...
		inFlightResponse = w
		serverHandler{c.server}.ServeHTTP(w, w.req.toHttp())
...
func (tw *timeoutWriter) Header() http.Header { return tw.h.toHttp() }
