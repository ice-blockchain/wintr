...
import (
	...
	"github.com/ice-blockchain/wintr/wsserver/internal/websocket/h2extendedconnect/internal/safefilepath"
)
...
func dirList(w ResponseWriter, r *http.Request, f File) {
...
func ServeContent(w ResponseWriter, req *http.Request, name string, modtime time.Time, content io.ReadSeeker) {
...
func serveContent(w ResponseWriter, r *http.Request, name string, modtime time.Time, sizeFunc func() (int64, error), content io.ReadSeeker) {
...
func checkIfMatch(w ResponseWriter, r *http.Request) condResult {
...
func checkIfNoneMatch(w ResponseWriter, r *http.Request) condResult {
...
func checkIfRange(w ResponseWriter, r *http.Request, modtime time.Time) condResult {
	if r.Method != "GET" && r.Method != "HEAD" {
		return condNone
	}
...
func checkPreconditions(w ResponseWriter, r *http.Request, modtime time.Time) (done bool, rangeHeader string) {
...
func serveFile(w ResponseWriter, r *http.Request, fs FileSystem, name string, redirect bool) {
...
func localRedirect(w ResponseWriter, r *http.Request, newPath string) {
...
func (f *fileHandler) ServeHTTP(w ResponseWriter, r *http.Request) {
	upath := r.URL.Path
